...
from tmo import Exchange, ExchangeVisualizer, AssetType, OrderType
...
class TestExchangeVisualizer:
    ...
    def test_record_snapshot_with_orders(self, exchange: Exchange, visualizer: ExchangeVisualizer) -> None:
        """测试记录包含订单的快照"""
        # 下一些订单
